...
@section('content')
    ...
    <div class="container" style="padding-top: 50px">
        ...
        <div class="row" style="padding-top: 30px">
            ...
            <div class="col-md-4">
                <form method="post" action="{{route('messages_upload')}}" >
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="titleInput">留言标题</label>
                        <input type="text" class="form-control" name="titleInput" placeholder="必填">
                        <small id="nameHelp" class="form-text text-muted">我们会保护您的信息隐私。</small>
                    </div>
                    <div class="form-group">
                        <label for="nameInput">您的姓名</label>
                        <input type="text" class="form-control" name="nameInput" placeholder="必填">
                    </div>
                    <div class="form-group">
                        <label for="emailInput">电子邮箱</label>
                        <input type="email" class="form-control" name="emailInput" placeholder="必填">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="textInput"></textarea>
                    </div>
